<style type="text/css">
    ...
    <img align="left" src="c:/image/JasaMarga.png" width="95px" height="85px" style="margin-right: 0">
    <img align="right" src="c:/image/bpjt.jpg" width="95px" height="85px" style="margin-right: 0">
    ...
    <br>
    <h4 style="font-family: sans-serif; background-color: #ddd; padding: 5px 5px 5px 5px;"><b>DATA RUAS TOL</b> <font style="float: right;"><?php date_default_timezone_set('Asia/Jakarta'); echo date('d F Y'); ?></font></h4>
    <table border="0" cellpadding="0" width="100%" style="font-family: sans-serif;color: #232323;border-collapse: collapse;">
    	...
    	<tbody>
    		...
    		<tr>
    			...
    			<td><?php $dta = $model->getCount($data->id_ruas)->row(); echo $dta->jumlahnya ?></td>
    		</tr>
    		<?php } ?>
            <tr>
