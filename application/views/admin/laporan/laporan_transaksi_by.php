<style type="text/css">
    ...
    <br>
    <h4 align="center" style="font-family: sans-serif; background-color: #ddd; padding: 5px 5px 5px 5px;"><b>DATA TRANSAKSI - RUAS TOL <font style="text-transform: uppercase;"><?php echo $ruas->nama_ruas ?></font></b></h4>
    <table border="0" cellpadding="0" width="100%" style="font-family: sans-serif;color: #232323;border-collapse: collapse;">
    	...
    	<tbody>
            ...
            <?php }else{ ?>
                <tr>
                    <p align="center">Data Belum Tersedia</p>
                </tr>
            <?php } ?>
    	</tbody>
