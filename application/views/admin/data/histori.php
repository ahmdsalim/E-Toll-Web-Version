...
<body class="hold-transition skin-blue fixed sidebar-mini" onload="autoload()">
<div class="wrapper">
  <!-- HEADER -->
            ...
            <div class="box-header bg-blue">
              ...
              <div class="box-tools pull-right">
                <form>
                  ...
                  <a class="btn btn-primary btn-sm" target="_blank" id="link"><i class="fa fa-print"></i> Cetak PDF</a>
                </form>
              </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="datatable" class="table table-hover">
                ...
                <tr align="center">
                  ...
                  <th class="btn-success text-white">Ruas Tol</th>
                ...
                <tbody>
                  <?php foreach ($dt_transaksi as $data) { ?>
                <tr>
                  ...
                  <td>
                    <a onclick="hapus('<=? $data->id_transaksi ?>')"
...
<script type="text/javascript">
    function autoload(){
      $("#link").attr("href", 'transaksi/laporan_semua');
    }
    ...
    if(value=="semua"){
      ...
      $("#link").attr("href",'transaksi/laporan_pdf/'+value);
    }
        ...
        Swal({
            ...
            if (result.value) {
                Swal({
                    ...
                    if(result.value) {
                        document.location.href = '<?= base_url()?>index.php/admin/transaksi/delete/' + id;
                    }
                })
            }
        })
