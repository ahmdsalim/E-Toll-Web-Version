      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url('index.php/admin/tarif/ubah/'.$dt->id_tarif) ?>" method="POST">
              <div class="box-body">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <select class="form-control select2" name="id_ruas" style="width: 100%;" id="ruas">
                      ...
                      <?php foreach ($ruas_tol as $ruas) { ?>
                      <option value="<?php echo $ruas['id_ruas'] ?>" <?php if ($ruas['id_ruas'] == "$dt->id_ruas") {
                        echo "selected=\"selected\""; } ?>><?php echo $ruas['nama_ruas']; ?></option>
                      <?php } ?>
                    </select>
                  ...
                  <div class="form-group">
                    ...
                    <?php $cabang = $model->getCabangBy($dt->id_ruas)->result_array(); ?>
                    <select class="form-control select2" name="masuk" style="width: 100%;" id="masuk">
                      <option value="" selected="selected">--Pilih--</option>
                      <?php foreach ($cabang as $data) { ?>
                      <option value="<?php echo $data['nama'] ?>" <?php if ($data['nama'] == "$dt->masuk") {
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control select2" name="keluar" style="width: 100%;" id="keluar">
                      <option value="" selected="selected">--Pilih--</option>
                      <?php foreach ($cabang as $data) { ?>
                      <option value="<?php echo $data['nama'] ?>" <?php if ($data['nama'] == "$dt->keluar") {
                        echo "selected=\"selected\""; } ?>><?php echo $data['nama']; ?></option>
                      <?php } ?>
                    </select>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" name="tarif" id="tarif" value="<?php echo $dt->tarif ?>" class="form-control">
                    </div>
